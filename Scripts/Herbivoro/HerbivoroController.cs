...
public class HerbivoroController : MonoBehaviour
{
                ...
                Color n_color)
    {
        ...
        perdida_energetica = (velocidad*campo_vision)/4;
    ...
    private void mutate()
    {
        ...
        ganar_reproduccion_critica = Random.Range(0.05f, 0.95f)*generationManager.max_stat;
    ...
    public void comer()
    {
        ...
        comidaObjetivo.GetComponent<PlantaController>().getDamage();
        hambre_actual = 0;
    }
    ...
    private void crear_nuevo_organismo()
    {
        ...
        HerbivoroController p2 = parejaObjetivo.GetComponent<HerbivoroController>();
        ...
        HerbivoroController n_criatura = Instantiate(generationManager.herbivoroPrefab, transform.position, transform.rotation).GetComponent<HerbivoroController>();
